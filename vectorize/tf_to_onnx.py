...
if __name__ == "__main__":
  ...
  parser.add_argument( "--onnx_model_file", type=str, default="../models/speccy_model_20220202.onnx", help="ONNX model path")
  parser.add_argument( "--tf_model_file", type=str, default="../models/speccy_model_20220202.tf", help="TensorFlow model path")
